...
This game is a narrative puzzle experience where the player gradually uncovers the meaning of an ancient symbolic language. You explore hand-crafted environments, interact with inscriptions, and update a dynamic Journal System that tracks every discovered glyph and meaning guess.
...
✨ Key Features 🧩 Language-Based Puzzle System
...
⚠️ Important: Running the game from any other branch may cause missing files, editor-only issues, or incomplete builds. Always use the clean-build branch for the fully packaged, ready-to-play version.
